package com.jiabb.filter;

import com.jiabb.controller.ValidateCodeController;
import com.jiabb.exception.ValidateCodeException;
...
public class ValidateCodeFilter extends OncePerRequestFilter {
    ...
    private void validate(HttpServletRequest request) {
        ...
        //拼接redis的key
        String redisKey = ValidateCodeController.REDIS_KEY_IMAGE_CODE + "-" + remoteAddr; //从redis中获取imageCode
